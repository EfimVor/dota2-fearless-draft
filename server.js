/**
 * Dota 2 Fearless Draft — WebSocket + Static Server
 * Готов к деплою на Render, Railway, свой VPS.
...
// HTTP сервер (раздаёт статику + API)
    ...
    ws.on('message', (rawData) => {
        ...
        switch (msg.type) {
            ...
            case 'SYNC_STATE': {
                ...
                broadcastToRoom(currentRoom, { type: 'STATE_SYNC', state: msg.state, captains: currentRoom.captains }, ws);
                break;
            }
